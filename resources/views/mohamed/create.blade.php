...
<section class="content" style="height: 586px">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">اضافة معلومات عن سيدنا محمد صلى الله عليه و سلم</div>
                ...
                <div class="card-body">
                    ...
                    <div class="panel panel-default">
				        ...
				        <div class="panel-body">
				            <form id="myForm" method="POST" action="{{ route('mohamedCreate') }}" enctype="multipart/form-data" data-validate="parsley">
				                {{ csrf_field() }}
