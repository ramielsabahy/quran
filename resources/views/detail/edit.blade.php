...
<section class="content" style="height: 586px">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"> تعديل دعوة تفصيلية </div>
                ...
                <div class="card-body">
                    ...
                    <div class="panel panel-default">
				        ...
				        <div class="panel-body">
				            <form id="myForm" method="POST" action="{{ route('updateDetailInvitation', ['id' => $invitation->id]) }}" enctype="multipart/form-data" data-validate="parsley">
				                {{ csrf_field() }}
				                <div class="form-group">
				                    <label for="name" style="float: right">
				                        النص
				                    </label>
				                    <input class="form-control" id="name" value="{{ $invitation->text }}" type="text" name="name" autocomplete="off" data-parsley-trigger="change focusout" data-parsley-required=''></input>
				                </div>
				                <div class="form-group">
