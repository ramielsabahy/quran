...
<section class="content" style="height: 586px">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">اضافة لغة جديدة</div>
                ...
                <div class="card-body">
                    ...
                    <div class="panel panel-default">
				        ...
				        <div class="panel-body">
				            <form id="myForm" method="POST" action="{{ route('languageCreate') }}" enctype="multipart/form-data" data-validate="parsley">
				                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="name" type="file" name="flag" autocomplete="off" data-parsley-trigger="change focusout" data-parsley-required=''></input>
                                </div>
				                <div class="form-group">
