					...
					@if($invitations->count() > 0)
						@foreach($invitations as $invitation)
							<tr>
								...
								<td>
									<a href="{{ route('editFastInvitation', ['id' => $invitation->id]) }}" class="btn btn-xs btn-info">
										تعديل
									</a>
								</td>
								<td>
									<a href="{{ route('deleteFastInvitation', ['id' => $invitation->id]) }}" class="btn btn-xs btn-danger">
										حذف
									</a>
								</td>
